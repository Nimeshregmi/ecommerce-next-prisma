            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                <Tabs defaultValue="description" className="w-full">
                  ...
                  >
                    <p>
                      This premium {product.productName} is designed for comfort
                      and style, perfect for everyday wear. Made with quality
                      materials that will last, this piece is a must-have
