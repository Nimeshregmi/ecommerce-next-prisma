      ...
      {categories.length > 0 && (
        <div className="w-full max-w-7xl px-4 py-16">
          <div className="mb-12 text-center">
            <h2 className="text-3xl md:text-5xl font-bold mb-3">Shop by Category</h2>
            <p className="text-gray-600 text-xl md:text-xl max-w-2xl mx-auto">
      ...
      <div className="w-full bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl font-bold mt-2 md:text-5xl mb-3">Featured Products</h2>
            <p className="text-gray-600 max-w-2xl text-xl md:text-xl mx-auto">
